...
export default {
	...
	payment(data, {
		...
		return new Promise(async (resolve, reject) => {
			await this.authenticate(onIncompletePaymentFoundCallback).then(async function(auth) {
				// resolve(auth);
				...
				await Pi.createPayment({
					...
					onReadyForServerApproval: function(paymentId) {
						...
						if (typeof(onReadyForServerApprovalCallback) ==
							"function") {
					...
					onReadyForServerCompletion: function(paymentId, txid) {
						...
						if (typeof(onReadyForServerCompletionCallback) ==
							"function") {
